...
exports.tipo_origen_transaccion = async (req, res) => {  
      
    const filePath = path.join(__dirname, 'utils', 'tipo_origen_transaccion.json');
...
exports.motivo_bloqueo_cuenta = async (req, res) => {  
      
    const filePath = path.join(__dirname, 'utils', 'motivo_bloqueo_cuenta.json');
    console.log('File Path:', filePath);    
    fs.readFile(filePath, 'utf8', (error, data) => {
        if (error) {
            return res.status(500).json({
...
exports.motivo_bloqueo_tarjeta = async (req, res) => {  
...
exports.estado_cuenta = async (req, res) => {  
      
    const filePath = path.join(__dirname, 'utils', 'estado_cuenta.json');
    console.log('File Path:', filePath);    
    fs.readFile(filePath, 'utf8', (error, data) => {
        if (error) {
            return res.status(500).json({
